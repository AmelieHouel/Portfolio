...
<body class="bg-purple">
  ...
  <section class="flex center hero-header" id="home">
    <div class="hero-titles">
      ...
      <h3 id="heroH3">UX/UI designer</h3>
    </div>
  ...
  <section class="flex center column presentation" id="presentation">
    <div class="presentation-container bg-white flex evenly"> 
      ...
      <div class="flex column center bg-blue aside">
        <a class="text-white" href="./PDF/CV-Amélie Houël-stage.pdf" target = "_blank"><p>Télécharger mon cv</p></a>
        <a class="text-white" href="./PDF/CV-Amélie Houël-stage.pdf" target = "_blank"><div class="flex column">
  ...
  <section class="bg-white projects" id="project">
    ...
    <div class="form-container">
      ...
      <form action="post.php" method="post">
        <div class="flex column">
            <label class="text-purple" for="name"> Votre identité : </label>
            <input type="text" id="name" name="username" required>
        </div>
        <div class="flex column">
            <label class="text-purple" for="mail"> Votre e-mail : </label>
            <input type="email" id="mail" name="mail" required>
        </div>
        <div class="flex column">
            <label class="text-purple" for="msg"> Votre Message : </label>
            <textarea id="msg" name="user_message" placeholder=" Avez-vous une question ?" wrap required></textarea>
        </div>
        <button class="bg-purple" type="submit">Envoyer</button>
      </form>
